...
final class WOOF_HELPER
{
    ...
    public static function get_price2_filter_data($additional_taxes = '')
    {
        ...
        if (isset($woof_settings['price_filter2_ranges']) AND ! empty($woof_settings['price_filter2_ranges']))
        {
            global $WOOF;
            $res = array();
            $request = $WOOF->get_request_data();
            ...
            $ranges = explode(',', $woof_settings['price_filter2_ranges']);
            $get = $request;
            ...
            foreach ($ranges as $value)
            {
                ...
                if ($show_count)
                {
                    $rc[$key] = $WOOF->dynamic_count(NULL, 'price2', $additional_taxes);
                } else
                {
                    $rc[$key] = 0;
                }
