    ...
    <div class="section">
        ...
        <div id="tabs">
            ...
            <div id="tabs-4">
                ...
                <h4 style="margin-bottom: 5px;"><?php _e('Image for subcategories - open', 'woocommerce-products-filter') ?></h4>
                <input style="width: 80%;" type="text" name="woof_settings[woof_auto_subcats_plus_img]" value="<?php echo @$woof_settings['woof_auto_subcats_plus_img'] ?>" /><br />
                ...
                <br />
                <h4 style="margin-bottom: 5px;"><?php _e('Image for subcategories - close', 'woocommerce-products-filter') ?></h4>
                <input style="width: 80%;" type="text" name="woof_settings[woof_auto_subcats_minus_img]" value="<?php echo @$woof_settings['woof_auto_subcats_minus_img'] ?>" /><br />
                ...
                <h4 style="margin-bottom: 5px;"><?php _e('Image for checked color type checkbox', 'woocommerce-products-filter') ?></h4>
                <input style="width: 80%;" type="text" name="woof_settings[checked_color_img]" value="<?php echo $woof_settings['checked_color_img'] ?>" /><br />
                ...
                <h4 style="margin-bottom: 5px;"><?php _e('Drop-down price filter ranges', 'woocommerce-products-filter') ?></h4>
                <input style="width: 80%;" type="text" name="woof_settings[price_filter2_ranges]" value="<?php echo $woof_settings['price_filter2_ranges'] ?>" /><br />
                ...
                <h4 style="margin-bottom: 5px;"><?php _e('Drop-down price filter text', 'woocommerce-products-filter') ?></h4>
                <input style="width: 80%;" type="text" name="woof_settings[price_filter2_1opt_txt]" value="<?php echo $woof_settings['price_filter2_1opt_txt'] ?>" /><br />
                ...
                <h4 style="margin-bottom: 5px;"><?php _e('SKU textinput placeholder', 'woocommerce-products-filter') ?></h4>
                <input style="width: 80%;" type="text" name="woof_settings[search_by_sku_placeholder_txt]" value="<?php echo $woof_settings['search_by_sku_placeholder_txt'] ?>" /><br />
                ...
                <h4 style="margin-bottom: 5px;"><?php _e('Image for sku input button', 'woocommerce-products-filter') ?></h4>
                <input style="width: 80%;" type="text" name="woof_settings[sku_submit_image]" value="<?php echo $woof_settings['sku_submit_image'] ?>" /><br />
                        ...
                        <td>
                            <fieldset>
                                <label>
                                    ...
                                    <input style="width: 80%;" placeholder="swoof" type="text" name="woof_settings[swoof_search_slug]" value="<?php echo $woof_settings['swoof_search_slug'] ?>" id="swoof_search_slug" /><br />
