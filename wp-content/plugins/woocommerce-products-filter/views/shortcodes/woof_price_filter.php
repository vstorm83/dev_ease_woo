...
if (isset($this->settings['price_filter2_1opt_txt']))
{
    if (!empty($this->settings['price_filter2_1opt_txt']))
    {
        $price_filter2_1opt_txt = $this->settings['price_filter2_1opt_txt'];
    }
}
...
<?php else: ?>
            ...
            <option value="0"><?php _e('Not possible. Enter options ranges in the plugin settings -> tab Miscellaneous -> Drop-down price filter ranges!', 'woocommerce-products-filter') ?></option>
