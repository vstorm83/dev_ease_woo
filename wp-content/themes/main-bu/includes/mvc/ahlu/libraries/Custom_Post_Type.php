...
class Custom_Post_Type
    {
                ...
                if( ! taxonomy_exists( $taxonomy_name ) )

                    {
                        ...
                        //Capitilize the words and make it plural
                            ...
                            Ahlu::Call("WP_Event")->Action()->Add_action( 'init',
        ...
        /* Listens for when the post type being loaded*/

        public function showFieldColunm($array=null)

        {
           ...
           // $columns = Ahlu::Call("Columns");

            

             

              Ahlu::Call("WP_Event")->Action()->Add_action("manage_posts_custom_column",function() use($column){
                     ...
                     global $post;
                      ...
                      switch ($column) {
                        ...
                        case "movie_genres":
                         ...
                         echo get_the_term_list($post->ID, 'movie_genre', '', ', ','');   
              ...
              Ahlu::Call("WP_Event")->Filter()->Add_filter("manage_edit-".$this->post_type_name."_columns", function() use( $columns){
       ...
       public function add_sub_menu($view=""){

           add_action('admin_menu' ,function() use($view){

                   add_submenu_page('edit.php?post_type=book', 'Custom Post Type Admin', 'Settings', 'manage_options', basename(__FILE__), function () use($view){
