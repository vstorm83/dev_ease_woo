				...
				.bx-wrapper  .bx-controls-direction{display:none;}
						...
						<?php
							echo implode("\n",array_map(function($img){
								return '<li><a class="fancybox" href="'.$img.'"><img src="'.$img.'" /></a></li>';
							},$post->gallery()));
						?>
							</ul>
						</div>
					...
					<div  class="read-brochure right ">
						<a target="_blank" href="<?php echo isset($me->link_pdf)?$me->link_pdf:"#"; ?>"><img src="<?php bloginfo('template_directory');?>/images/read-brochure_1.png"  /></a>
					</div>
				</div>
			</div>
