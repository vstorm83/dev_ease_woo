...
*  Class Service
*/
class Service extends Ahlu_post
{
...
error_reporting(0);
	   ...
	   $this->news_model = Ahlu::Call("Service_model",35); 
	...
	*/
	public function category($id=-1){
	   ...
	   //assign data   for content 
		...
		$this->news_model = Ahlu::Call("Service_model",$this->category); 
		$this->template->assign("meta",$this->news_model->SEO());
	...
	*/
	public function post($id){
		$cls = strtolower(__CLASS__);
           ...
           $this->post_model = Ahlu::Call("Service_item_model")->load($this->post); 
