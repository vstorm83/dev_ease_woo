 <?php
    ...
    */
    ...
    class Ecommercial_model extends Category_model

    {
		...
		*/
        public function categories($array=null){
           ...
           $db = $this->db;
             $query = "SELECT * from $db->term_taxonomy as t2 join $db->terms as t1 on t1.term_id = t2.term_id where t2.taxonomy='{$this->taxonomy}'";
            //echo $query;
